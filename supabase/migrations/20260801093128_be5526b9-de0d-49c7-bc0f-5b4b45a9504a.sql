...
insert into public.data_sources (id, name, base_url, source_type, terms_url, attribution_text, refresh_policy) values
 ('55555555-0000-4000-8000-000000000001','Demo Marketplace Feed','https://demo.marketplace.example','partner_api','https://demo.marketplace.example/terms','Demo partner feed (synthetic sample data — not live marketplace data)','hourly'),
 ('55555555-0000-4000-8000-000000000002','Demo Completed Sales Index','https://demo.comps.example','public_api','https://demo.comps.example/terms','Demo completed-sale index (synthetic sample data — not live marketplace data)','daily'),
